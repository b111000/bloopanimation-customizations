...
class BACU_BloopAnimation_Customizations_Assets {
    ...
    public static function css_styles() {
        ob_start();
        ?>
            <link rel='stylesheet' id='bloopanimation-main' href='<?php echo esc_url( plugins_url( 'assets/css/main.css', dirname(__DIR__) ) ); ?>?ver=1.0.0.118121' type='text/css' media='all' />
        <?php
